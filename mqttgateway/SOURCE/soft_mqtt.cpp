...
//const std::string SERVER_ADDRESS("tcp://192.168.43.128:1883");
...
public:
	callbackmqtt(mqtt::async_client& cli, mqtt::connect_options& connOpts)
		: nretry_(0), cli_(cli), connOpts_(connOpts), subListener_("Subscription") {}
};
int MyMqtt::connect(char* ipaddress, char* clientid,char* username,char* password)
{
